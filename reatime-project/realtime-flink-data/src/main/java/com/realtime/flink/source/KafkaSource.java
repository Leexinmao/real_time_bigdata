...
public class KafkaSource {
     ...
     * @return
     */
    public static DataStream<String> KafkaSource(StreamExecutionEnvironment env,String server,String topic){
    ...
    public static DataStream<String> KafkaSource(StreamExecutionEnvironment env){
        Properties properties = new Properties();
