package com.realtime.data

import java.util.Date

import com.alibaba.fastjson.{JSON, JSONObject}
import com.realtime.data.utils.{LogUploader, RandomNumUtils, RandomOptions}
...
object JsonMocks {
  ...
  def initOneStartupLog(): String = {
     ...
     */
    val mid: String = "mid_" + RandomNumUtils.randomInt(1, 500)
    val uid: String = "" + RandomNumUtils.randomInt(1, 10000)
  ...
  def initOneEventLog(startupLogJson: String) = {
    ...
    eventLogObj.put("pageId", RandomNumUtils.randomInt(1, 50))
    eventLogObj.put("nextPageId", RandomNumUtils.randomInt(1, 50))
    eventLogObj.put("itemId", RandomNumUtils.randomInt(1, 50))
